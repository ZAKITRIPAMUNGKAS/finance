<div id="register-container" 
    ...
    <!-- ═══════════════════════════════════════════════════════════ -->
    <!--  1. LIVEWIRE REGISTRATION LOADING OVERLAY                   -->
    <!-- ═══════════════════════════════════════════════════════════ -->
    <div wire:loading.flex 
        ...
        <div class="relative z-10 max-w-sm w-full space-y-4 flex flex-col items-center">
            <!-- Pure Transparent Brand Logo (No Background Box) -->
            <img src="{{ asset('images/logo.svg') }}" class="w-16 h-16 object-contain animate-pulse drop-shadow-xl" alt="PortoFinance">
    ...
    <div x-show="isGoogleLoading" 
        ...
        <div class="relative z-10 max-w-sm w-full space-y-4 flex flex-col items-center">
            <!-- Pure Transparent Google Logo (No Background Box) -->
            <svg class="w-14 h-14 drop-shadow-lg" viewBox="0 0 24 24">
